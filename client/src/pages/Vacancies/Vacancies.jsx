...
function Vacancies() {
    ...
    const inputConfigSearch = [
        { title: 'Tìm kiếm theo vị trí tuyển dụng', type: 'text', name: 'search', placeholder: 'Ví dụ: Lập trình viên' },
    ];
                ...
                isLoading ? (
                    ...
                    <div className={styles.vacanciesSection}>
                        ...
                        <div className={`content`}>
                            <h3 className={`title`}>Việc làm</h3>
                            <SearchForm
                                ...
                                <div className={`cards-content`}>
                                    {vacancies && vacancies.length > 0 ? (
                                        ...
                                        <div className='searchNotFound'>
                                            ...
                                            <GreenButton
                                                title={"Quay lại trang tuyển dụng"}
