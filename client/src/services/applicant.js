...
export async function deleteApplicant(applicant_id, applicants, setApplicants) {
    try {
        console.log("Sending delete request for applicant ID:", applicant_id);
        ...
        console.error("Error deleting applicant:", error.response ? error.response.data.detail : error.message);
    }
}
